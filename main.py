...
def run_experiment(args, experiments=None, dsc=None, samples=10, scope=None):
    ...
    for exp_key in experiments.keys():
        ...
        while sample_no < samples:
            ...
            # create dataset for main diagonal -- day one
            ...
            # create dataset for off diagonal, depending on task -- day two
            ...
            # create all validation datasets
            ...
            for epoch in range(args.epochs):
                ...
                for batch_idx, (inputs, targets) in enumerate(round_one_trainloader):
                    model.train()
                    global_step += 1
                ...
                test_reports_acc = {}
                for task in testloaders.keys():
                    test_loss, test_acc = test(testloaders[task], model, criterion, use_cuda)
